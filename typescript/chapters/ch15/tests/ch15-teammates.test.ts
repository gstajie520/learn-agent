...
import type { MailboxMessage, MailboxStore } from "../src/features/mailbox.js";
import { MailboxMessageKind } from "../src/features/mailbox.js";
...
class FailFirstReleaseStore implements MailboxStore {
  ...
  async claim(recipient: string): Promise<MailboxMessage | undefined> {
    return await this.#inner.claim(recipient);
  }
