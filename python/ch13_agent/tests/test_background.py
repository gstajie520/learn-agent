...
from agent_ch13.adapters.background_json import JsonBackgroundJobStore
from agent_ch13.core.events import EventInbox, runtime_event_message
from agent_ch13.core.tools import ToolResult, tool_success
from agent_ch13.features.background import (
    BackgroundError,
    BackgroundJob,
    BackgroundJobEvent,
    JobSupervisor,
...
def test_event_inbox_only_accepts_runtime_event() -> None:
    ...
    event = BackgroundJobEvent(EVENT_ID, JOB_ID, "call-1", "shell", "completed", tool_success("完成"))
    inbox.publish(event)
