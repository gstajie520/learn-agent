...
def build_agent(
    ...
    if hooks is not None and profile not in (P04, P05, P06, P07, P08, P09, P10, P11, P12, P13):
    ...
    if profile in (P03, P04, P05, P06, P07, P08, P09, P10, P11, P12, P13):
    ...
    return AgentRunner(
        ...
        event_pump=background_supervisor if background_supervisor is not None else None,
        resources=(background_supervisor,) if background_supervisor is not None else (),
    )
