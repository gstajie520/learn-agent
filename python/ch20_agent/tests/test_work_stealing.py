...
from agent_ch20.features.tasks import CreateTaskInput, Task, TaskCompletion
from agent_ch20.features.work_stealing import (
    TaskClaim,
    WorkStealingRuntime,
...
def test_create_tool_maps_blocked_by_and_claim_prompt_contains_lease() -> None:
    ...
    call = tools.prepare(
        __import__("agent_ch20.core.messages", fromlist=["tool_call"]).tool_call(
            "call-1",
            "create_task",
            json.dumps(
                {
