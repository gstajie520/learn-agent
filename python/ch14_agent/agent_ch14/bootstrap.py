...
def build_agent(
    ...
    if hooks is not None and profile not in (P04, P05, P06, P07, P08, P09, P10, P11, P12, P13, P14):
    ...
    tools = (
        ...
        if profile is P01
        else create_chapter_two_tools(command, actual_file_system, background=profile is P13)
    )
    policy: PermissionPolicy | None = None
    if profile in (P03, P04, P05, P06, P07, P08, P09, P10, P11, P12, P13, P14):
    ...
    return AgentRunner(
        ...
        event_pump=cron_runtime if cron_runtime is not None else background_supervisor,
