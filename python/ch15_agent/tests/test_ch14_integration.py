...
from agent_ch15.adapters.task_json import JsonTaskStore
...
from agent_ch15.core.profiles import P14, profile_for_chapter
from agent_ch15.features.background import JobSupervisor
from agent_ch15.features.cron import CronRuntime
from agent_ch15.features.recovery import RecoveryConfig
...
class AllowApproval:
    def decide(self, request):  # type: ignore[no-untyped-def]
        from agent_ch15.core.permissions import PermissionDecision
