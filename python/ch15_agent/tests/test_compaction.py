...
from agent_ch15.core.messages import (
    assistant_message,
    system_message,
    tool_call,
    tool_message,
...
from agent_ch15.core.tools import tool_error, tool_success
from agent_ch15.features.compaction import (
...
class RecordingSummarizer:
    ...
    def summarize(self, history):
        ...
        return CompactionSummary(
            "继续迁移第九章",
            ("按完整消息组压缩",),
            ("agent_ch15/features/compaction.py",),
            ("运行测试",),
            ("不能拆散工具消息",),
        )
