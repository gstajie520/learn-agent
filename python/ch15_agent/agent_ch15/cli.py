"""第十五章命令行入口：主模型请求带持久队友与 Cron 调度资源。"""
...
def main() -> int:
    """解析参数、读取共享配置、装配 P15 持久队友 Agent 并运行。"""
    parser = argparse.ArgumentParser(description="第十五章持久队友 Agent")
