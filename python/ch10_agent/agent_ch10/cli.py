"""第十章命令行入口：使用运行态模块化 system prompt。"""
...
def main() -> int:
    """解析参数、读取共享 `python/.env`、装配 P10 Agent 并运行。"""
    parser = argparse.ArgumentParser(description="第十章动态模块化 system prompt")
