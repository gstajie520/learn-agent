"""组合根：按固定 Profile 装配第 1 到第 10 章累计能力。
...
from .core.profiles import P01, P02, P03, P04, P05, P06, P07, P08, P09, P10, ChapterProfile
...
def build_agent(
    ...
    if hooks is not None and profile not in (P04, P05, P06, P07, P08, P09, P10):
    ...
    if profile in (P03, P04, P05, P06, P07, P08, P09, P10):
