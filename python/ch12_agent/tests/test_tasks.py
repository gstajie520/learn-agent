...
from agent_ch12.core.messages import tool_call
from agent_ch12.core.tools import ToolContext, ToolRegistry
from agent_ch12.features.tasks import (
    CreateTaskInput,
    TaskBlockedError,
    TaskGraphError,
    TaskNotFoundError,
...
def test_registers_five_strict_tools_and_runs_owner_checked_workflow(tmp_path: Path) -> None:
    ...
    endpoint = invoke(
        "2", "create_task", {"subject": "endpoint", "blocked_by": [IDS[0]]}
    )
