from agent_ch01.core.messages import assistant_message, tool_call, tool_message, user_message, validate_tool_pairing, MessageContractError
...
def test_rejects_incomplete_group():
    try:
        ...
        assert "missing tool results" in str(error)
