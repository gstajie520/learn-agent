...
def main() -> int:
    """解析参数、读取共享配置、装配 P17 SQLite 自驱协作 Agent。"""
    parser = argparse.ArgumentParser(description="第十七章 SQLite 任务认领与自驱队友 Agent")
    ...
    try:
        ...
        work_stealing = WorkStealingRuntime(task_store)
        runner = build_agent(
            P17,
