...
def build_agent(
    ...
    if profile is P17 and work_stealing_runtime is None:
        raise ValueError("第十七章必须提供 work_stealing_runtime")
    if profile is not P17 and work_stealing_runtime is not None:
        raise ValueError("work_stealing_runtime 只适用于第十七章")
    if profile is P17:
        if task_store is None or work_stealing_runtime is None:
            raise ValueError("第十七章必须提供 SQLite task_store 和 work_stealing_runtime")
    ...
    if profile in (P03, P04, P05, P06, P07, P08, P09, P10, P11, P12, P13, P14, P15, P16, P17):
    ...
    if "subagent" in profile.capabilities:
        ...
        def child_tools_factory() -> tuple[ToolRegistry, TodoTracker]:
            ...
            if profile is P17 and work_stealing_runtime is not None:
                register_leased_task_tools(
