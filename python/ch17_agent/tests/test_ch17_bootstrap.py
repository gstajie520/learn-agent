...
from agent_ch17.adapters.background_json import JsonBackgroundJobStore
from agent_ch17.adapters.cron_json import JsonCronStore
from agent_ch17.adapters.mailbox_json import FileMailboxStore
from agent_ch17.adapters.task_sqlite import SqliteTaskStore
from agent_ch17.bootstrap import build_agent
from agent_ch17.core.events import EventInbox
from agent_ch17.core.permissions import PermissionDecision
from agent_ch17.core.profiles import P17
from agent_ch17.features.background import JobSupervisor
from agent_ch17.features.cron import CronRuntime
from agent_ch17.features.protocol import JsonProtocolStore, ProtocolRuntime
from agent_ch17.features.recovery import RecoveryConfig
from agent_ch17.features.teammates import TeammateRuntime
from agent_ch17.features.work_stealing import WorkStealingRuntime


class Model:
    def complete(self, _request):  # type: ignore[no-untyped-def]
        from agent_ch17.core.messages import assistant_message
        from agent_ch17.core.model import ModelReply
