...
| 9 | 上下文工程：计划、压缩、记忆、按需加载 | 4 | Python/TypeScript | ch05、ch06、ch07、ch08、ch09、ch10 |
...
合计约 37 周。阶段 1-8 已占前 16 周，剩余约 21 周（阶段 9 已完成前 2 课）。

#### 周数是怎么估的（2026-09-01 重新标定）
